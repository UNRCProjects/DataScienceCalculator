...
from frontend.aritmetica import mcd_view, mcm_view, primos_view, coprimos_view, matriz_view
...
with st.sidebar.expander("🧮 Aritmética"):
    ...
    if st.button("Multiplicación de Matrices", key="matriz_btn"):
        st.session_state['categoria'] = "Aritmética"
        st.session_state['subopcion'] = "Matriz"
...
elif categoria == "Aritmética" and subopcion == "Matriz":
    matriz_view.render()
